...
export default function BundleDetails(props: BundleDetailsProps) {
    ...
    return (<>
        <Grid container spacing={1} data-testid="bundle-details">
            ...
            <NameValue name={t('supported_capital')} value={symbol + " " + formatCurrencyBN(capitalSupport, props.decimals)}/>
            <NameValue name={t('supported_capital_remaining')} value={symbol + " " + formatCurrencyBN(capitalSupportRemaining, props.decimals)}/>
