...
import type { Riskpool2, Riskpool2Interface } from "../Riskpool2";
...
export class Riskpool2__factory {
  static readonly abi = _abi;
  static createInterface(): Riskpool2Interface {
    return new utils.Interface(_abi) as Riskpool2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Riskpool2 {
    return new Contract(address, _abi, signerOrProvider) as Riskpool2;
  }
}
