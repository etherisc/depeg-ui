...
import type {
  IInstanceService,
  IInstanceServiceInterface,
} from "../../../../dependencies/etherisc/gif-interface@3b0002a/IInstanceService";
...
export class IInstanceService__factory {
  ...
  static createInterface(): IInstanceServiceInterface {
    return new utils.Interface(_abi) as IInstanceServiceInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IInstanceService {
    return new Contract(address, _abi, signerOrProvider) as IInstanceService;
  }
}
