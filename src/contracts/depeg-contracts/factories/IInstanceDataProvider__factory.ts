...
import type {
  ...
  IInstanceDataProviderInterface,
} from "../IInstanceDataProvider";
...
export class IInstanceDataProvider__factory {
  static readonly abi = _abi;
  static createInterface(): IInstanceDataProviderInterface {
    return new utils.Interface(_abi) as IInstanceDataProviderInterface;
  }
  static connect(
    address: string,
