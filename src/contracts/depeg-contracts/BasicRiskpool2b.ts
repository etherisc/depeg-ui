...
export interface BasicRiskpool2bInterface extends utils.Interface {
  functions: {
...
export interface BasicRiskpool2b extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BasicRiskpool2bInterface;
