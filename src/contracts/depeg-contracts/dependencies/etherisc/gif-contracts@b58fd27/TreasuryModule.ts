...
export interface TreasuryModuleInterface extends utils.Interface {
  functions: {
    "FRACTIONAL_FEE_MAX()": FunctionFragment;
    "FRACTION_FULL_UNIT()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "FRACTIONAL_FEE_MAX",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "FRACTION_FULL_UNIT",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TreasuryModule extends BaseContract {
  ...
  functions: {
    FRACTIONAL_FEE_MAX(overrides?: CallOverrides): Promise<[BigNumber]>;

    FRACTION_FULL_UNIT(overrides?: CallOverrides): Promise<[BigNumber]>;
