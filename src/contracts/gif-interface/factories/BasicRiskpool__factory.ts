...
import type { BasicRiskpool, BasicRiskpoolInterface } from "../BasicRiskpool";
...
export class BasicRiskpool__factory {
  static readonly abi = _abi;
  static createInterface(): BasicRiskpoolInterface {
    return new utils.Interface(_abi) as BasicRiskpoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BasicRiskpool {
    return new Contract(address, _abi, signerOrProvider) as BasicRiskpool;
  }
}
